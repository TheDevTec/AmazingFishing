...
public class Settings {
	...
	public static void open(Player p) {
		GUI a = Create.setup(new GUI(Create.title("settings.title"),54), Create.make("settings.close").build(),  s -> Help.open(s), me.devtec.amazingfishingOLD.utils.Create.Settings.SIDES);
